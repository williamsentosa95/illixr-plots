...
data_path_1 = "data_mobicom/latency_rte_cm.csv"
data_path_2 = "data_mobicom/latency_rte_degree.csv"
...
plt.savefig('latency_rte.pdf', bbox_inches='tight')
